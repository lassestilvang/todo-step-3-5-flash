...
export function getTasksByListId(listId: string): (TaskRow & { labels: any[]; subtasks: any[] })[] {
...
export function getOverdueTasks(): (TaskRow & { labels: any[]; subtasks: any[] })[] {
...
export function getTasksDueInNextDays(days: number): (TaskRow & { labels: any[]; subtasks: any[] })[] {
  const now = new Date();
